    ...
    public partial class FilterSimulationWithTablesAndGraphs
    {
        ...
        private void AddRow()
        {
            ...
            fmAdditionalFilterMachiningBlock fmb = new fmAdditionalFilterMachiningBlock(true, calculationOptionViewInTablesAndGraphs,
                                                                    ...
                                                                    row.Cells[GetColumnIndexByHeader(additionalParametersTable, fmGlobalParameter.hc_tf.name)],
                                                                    row.Cells[GetColumnIndexByHeader(additionalParametersTable, fmGlobalParameter.dhc_dt.name)],
