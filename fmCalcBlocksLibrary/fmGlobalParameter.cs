...
namespace fmCalcBlocksLibrary
{
    public class fmGlobalParameter
    {
        ...
        static fmGlobalParameter()
        {
            ...
            AddParameter(ref Qf_d, new fmGlobalParameter("Qf_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
            AddParameter(ref Qs, new fmGlobalParameter("Qs", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
            AddParameter(ref Qs_d, new fmGlobalParameter("Qs_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
            AddParameter(ref Qc, new fmGlobalParameter("Qc", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
            AddParameter(ref Qc_d, new fmGlobalParameter("Qc_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
            AddParameter(ref Qsus, new fmGlobalParameter("Qsus", fmUnitFamily.FlowRateVolume, new fmRange(0, 0.002)));
            AddParameter(ref Qsus_d, new fmGlobalParameter("Qsus_d", fmUnitFamily.FlowRateVolume, new fmRange(0, 0.002)));
            AddParameter(ref Qmsus, new fmGlobalParameter("Qmsus", fmUnitFamily.FlowRateMass, new fmRange(0, 2)));
            AddParameter(ref Qmsus_d, new fmGlobalParameter("Qmsus_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 2)));
            AddParameter(ref Qms, new fmGlobalParameter("Qms", fmUnitFamily.FlowRateMass, new fmRange(0, 2)));
            AddParameter(ref Qms_d, new fmGlobalParameter("Qms_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 2)));
            AddParameter(ref Qmf, new fmGlobalParameter("Qmf", fmUnitFamily.NoUnitFamily, new fmRange(0, 2)));
            AddParameter(ref Qmf_d, new fmGlobalParameter("Qmf_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 2)));
            AddParameter(ref Qmc, new fmGlobalParameter("Qmc", fmUnitFamily.NoUnitFamily, new fmRange(0, 2)));
            AddParameter(ref Qmc_d, new fmGlobalParameter("Qmc_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 2)));
            AddParameter(ref qf, new fmGlobalParameter("qf", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
            AddParameter(ref qf_d, new fmGlobalParameter("qf_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
            AddParameter(ref qs, new fmGlobalParameter("qs", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
            AddParameter(ref qs_d, new fmGlobalParameter("qs_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
            ...
            AddParameter(ref qsus_d, new fmGlobalParameter("qsus_d", fmUnitFamily.NoUnitFamily, new fmRange(0, 0.002)));
