...
Please create simulations in checked series.", @"Error!", MessageBoxButtons.OK);
        ...
        // ReSharper restore InconsistentNaming
        {
            ...
            if (cosd.ShowDialog() == DialogResult.OK)
            {
                ...
                Solution.currentObjects.Simulation.deliquoringEps0NeEpsBlock.SetCalculationOptionAndRewrite(cosd.deliquoringUsedCalculationOption);
                ...
                Solution.currentObjects.Simulation.deliquoringSigmaPkeBlock.SetCalculationOptionAndRewrite(cosd.deliquoringUsedCalculationOption);
