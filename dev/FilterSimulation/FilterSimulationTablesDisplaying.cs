    ...
    public partial class FilterSimulation
    {
        ...
        private void InitCommonFilterMachiningBlock()
        {
            ...
            commonFilterMachiningBlock = new fmCalcBlocksLibrary.Blocks.fmFilterMachiningBlock(
                parToCell[fmGlobalParameter.A],
                parToCell[fmGlobalParameter.Dp],
                parToCell[fmGlobalParameter.sf],
                parToCell[fmGlobalParameter.n],
                parToCell[fmGlobalParameter.tc],
                parToCell[fmGlobalParameter.tf],
                parToCell[fmGlobalParameter.tr],
                parToCell[fmGlobalParameter.hc_over_tf],
                parToCell[fmGlobalParameter.dhc_over_dt],
                parToCell[fmGlobalParameter.hc],
                parToCell[fmGlobalParameter.Mf],
                parToCell[fmGlobalParameter.Vf],
                parToCell[fmGlobalParameter.mf],
                parToCell[fmGlobalParameter.vf],
                parToCell[fmGlobalParameter.ms],
                parToCell[fmGlobalParameter.vs],
                parToCell[fmGlobalParameter.msus],
                parToCell[fmGlobalParameter.vsus],
                parToCell[fmGlobalParameter.mc],
                parToCell[fmGlobalParameter.vc],
                parToCell[fmGlobalParameter.Msus],
                parToCell[fmGlobalParameter.Vsus],
                parToCell[fmGlobalParameter.Vc],
                parToCell[fmGlobalParameter.Mc],
                parToCell[fmGlobalParameter.Ms],
                parToCell[fmGlobalParameter.Vs],
                parToCell[fmGlobalParameter.Qf],
                parToCell[fmGlobalParameter.Qf_d],
                parToCell[fmGlobalParameter.Qs],
                parToCell[fmGlobalParameter.Qs_d],
                parToCell[fmGlobalParameter.Qc],
                parToCell[fmGlobalParameter.Qc_d],
                parToCell[fmGlobalParameter.Qsus],
                parToCell[fmGlobalParameter.Qsus_d],
                parToCell[fmGlobalParameter.Qmsus],
                parToCell[fmGlobalParameter.Qmsus_d],
                parToCell[fmGlobalParameter.Qms],
                parToCell[fmGlobalParameter.Qms_d],
                parToCell[fmGlobalParameter.Qmf],
                parToCell[fmGlobalParameter.Qmf_d],
                parToCell[fmGlobalParameter.Qmc],
                parToCell[fmGlobalParameter.Qmc_d],
                parToCell[fmGlobalParameter.qf],
                parToCell[fmGlobalParameter.qf_d],
                parToCell[fmGlobalParameter.qs],
                parToCell[fmGlobalParameter.qs_d],
                ...
                parToCell[fmGlobalParameter.qmc],
                parToCell[fmGlobalParameter.qmc_d],
                parToCell[fmGlobalParameter.eps],
                parToCell[fmGlobalParameter.kappa],
                parToCell[fmGlobalParameter.Pc],
                parToCell[fmGlobalParameter.rc],
                parToCell[fmGlobalParameter.a]);
