...
namespace fmCalculatorsLibrary
{
    public class fmFilterMachiningCalculator : fmBaseCalculator
    {
        ...
        {
            throw new Exception("only_limit_clue not implemented.");
...
*/
        ...
        private void DoSubCalculationsStandartAndDesignGlobalQpConstVolumetricPump()
        {
            ...
            else
            {
                ...
                Dp.value = fmCalculationLibrary.NumericalMethods.fmBisectionMethod.FindRoot(qpCalc, new fmValue(0), new fmValue(1e9), 30);
