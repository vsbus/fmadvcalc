...
namespace fmCalculatorsLibrary
{
    public class fmFilterMachiningCalculator : fmBaseCalculator
    {
        ...
        public void DoCalculationsLimitsClue()
        {
            ...
            {
                DoCalculationsStandartAndDesignGlobalDpConst_OnlyLimitClueParams();
            }
            else if (calculationOption == fmFilterMachiningCalculationOption.STANDART_AND_DESIGN_GLOBAL_QP_CONST)
            {
                DoCalculationsStandartAndDesignGlobalQpConst_OnlyLimitClueParams();
            }
            else 
            {
                DoCalculations();
        ...
        private void DoCalculationsStandartAndDesignGlobalQpConst_OnlyLimitClueParams()
        {
        ...
        private void DoCalculationsStandartAndDesignGlobalDpConst_OnlyLimitClueParams()
        {
            // ReSharper disable InconsistentNaming
            var A = variables[fmGlobalParameter.A] as fmCalculationVariableParameter;
            var Dp = variables[fmGlobalParameter.Dp] as fmCalculationVariableParameter;
