...
namespace fmCalcBlocksLibrary.Blocks
{
    static public class fmCalculationOptionHelper
    {
        public static List<fmGlobalParameter> GetParametersListThatCanBeInput(fmFilterMachiningCalculator.fmFilterMachiningCalculationOption calculationOption)
        {
            ...
            switch (calculationOption)
            {
                ...
                case fmFilterMachiningCalculator.fmFilterMachiningCalculationOption.PLAIN_DP_CONST:
                    result.Add(fmGlobalParameter.A);
                ...
                //[Description("global: (A, Q), (Dp, Qp), (sf, sr, tr), (hc, V, M, tf, n, tc)")]
                case fmFilterMachiningCalculator.fmFilterMachiningCalculationOption.PLAIN_QP_CONST:
                    result.Add(fmGlobalParameter.A);
                    result.Add(fmGlobalParameter.Qmsus);
                    result.Add(fmGlobalParameter.Qsus);
                    result.Add(fmGlobalParameter.Qmf);
                ...
                //[Description("global: (A, Q), (Dp), (Qp, qp, t1, h1), (sf, sr, tr), (hc, V, M, tf, n, tc)")]
                case fmFilterMachiningCalculator.fmFilterMachiningCalculationOption.PLAIN_CENTRIPETAL_PUMP_QP_DP_CONST:
                    result.Add(fmGlobalParameter.A);
                    result.Add(fmGlobalParameter.Qmsus);
                    result.Add(fmGlobalParameter.Qsus);
                    result.Add(fmGlobalParameter.Qmf);
                    ...
                    result.Add(fmGlobalParameter.h1);
                ...
                //[Description("global: (A, Q), d, Dp, (Qp, qp, t1, h1), (sf, sr, tr), (hc, V, M, tf, n, tc)]
                case fmFilterMachiningCalculator.fmFilterMachiningCalculationOption.CYLINDRICAL_CENTRIPETAL_PUMP_QP_DP_CONST:
                    result.Add(fmGlobalParameter.d0);
                ...
                //(A, Q), d0, (Dp, Qp), (sf, sr, tr), (hc, V, M, tf, n, tc)")]
                case fmFilterMachiningCalculator.fmFilterMachiningCalculationOption.CYLINDRICAL_VOLUMETRIC_PUMP_QP_CONST:
                    result.Add(fmGlobalParameter.d0);
    ...
    public class fmFilterMachiningBlock : fmBaseBlock
    {
        ...
        private readonly fmBlockVariableParameter a;
        private readonly fmBlockVariableParameter t1;
        private readonly fmBlockVariableParameter h1;
        private readonly fmBlockVariableParameter t1_over_tf;
        private readonly fmBlockVariableParameter h1_over_hc;
        ...
        public fmFilterMachiningBlock(
            ...
            DataGridViewCell a_Cell,
            DataGridViewCell t1_Cell,
            DataGridViewCell h1_Cell,
            DataGridViewCell t1_over_tf_Cell,
            DataGridViewCell h1_over_hc_Cell)
        // ReSharper restore InconsistentNaming
        {
        ...
        public void SetCalculationOptionAndRewriteData(fmFilterMachiningCalculator.fmEvaporationUsedCalculationOption newCalculationOption)
        {
            SetCalculationOptionAndUpdateCellsStyle(newCalculationOption);
            ReWriteParameters();
        }
        ...
        public void SetCalculationOptionAndUpdateCellsStyle(fmFilterMachiningCalculator.fmEvaporationUsedCalculationOption newCalculationOption)
        {
            evaporationUsedCalculationOption = newCalculationOption;
        }
        ...
        fmBlockParameterGroup WhatGroupOfParameterWithCalcOption(fmBlockVariableParameter parameter, fmFilterMachiningCalculator.fmFilterMachiningCalculationOption calcOption)
        {
            if (m_tables == null)
            {
                ...
                SetGroupsOfStandartDpQpConst(m_tables[fmFilterMachiningCalculator.fmFilterMachiningCalculationOption.PLAIN_CENTRIPETAL_PUMP_QP_DP_CONST]);
                SetGroupsOfPlainQpConstVolumetricPump(m_tables[fmFilterMachiningCalculator.fmFilterMachiningCalculationOption.PLAIN_VOLUMETRIC_PUMP_QP_CONST]);
                ...
                SetGroupsOfCandleDpQpConst(m_tables[fmFilterMachiningCalculator.fmFilterMachiningCalculationOption.CYLINDRICAL_CENTRIPETAL_PUMP_QP_DP_CONST]);
                SetGroupsOfCylindricalQpConstVolumetricPump(m_tables[fmFilterMachiningCalculator.fmFilterMachiningCalculationOption.CYLINDRICAL_VOLUMETRIC_PUMP_QP_CONST]);
        ...
        private void SetGroupsOfCylindricalQpConstVolumetricPump(Dictionary<fmBlockVariableParameter, fmBlockParameterGroup> table)
        {
            foreach (fmBlockVariableParameter p in parameters)
                table[p] = null;

            //[Description("global: (A, Q), d0, (Dp, Qp), (sf, tr), (hc, V, M, tf, n, tc)")]
            table[d0] = d0_group;
        ...
        private void SetGroupsOfPlainQpConstVolumetricPump(Dictionary<fmBlockVariableParameter, fmBlockParameterGroup> table)
        {
            foreach (fmBlockVariableParameter p in parameters)
                table[p] = null;

            //[Description("global: (A, Q), (Dp, Qp), (sf, tr), (hc, V, M, tf, n, tc)")]
            table[A] = AQ_group;
            table[Qmsus] = AQ_group;
            table[Qsus] = AQ_group;
            table[Qmf] = AQ_group;
        ...
        private void SetGroupsOfCandleDpConst(Dictionary<fmBlockVariableParameter, fmBlockParameterGroup> table)
        {
            foreach (fmBlockVariableParameter p in parameters)
                table[p] = null;
        ...
        private void SetGroupsOfCandleQpConst(Dictionary<fmBlockVariableParameter, fmBlockParameterGroup> table)
        {
            foreach (fmBlockVariableParameter p in parameters)
                table[p] = null;
        ...
        private void SetGroupsOfCandleDpQpConst(Dictionary<fmBlockVariableParameter, fmBlockParameterGroup> table)
        {
            foreach (fmBlockVariableParameter p in parameters)
                table[p] = null;
        ...
        private void SetGroupsOfStandartDpQpConst(Dictionary<fmBlockVariableParameter, fmBlockParameterGroup> table)
        {
            foreach (fmBlockVariableParameter p in parameters)
                table[p] = null;
